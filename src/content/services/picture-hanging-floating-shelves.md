...
includedServices:
  - "Picture and frame hanging, single pieces or full gallery walls"
  - "Mirror hanging, including heavy and oversized mirrors"
  - "Floating shelf installation with concealed brackets"
  - "Stud-anchored and heavy-duty anchor mounting for weight-rated hardware"
  - "Gallery-wall layout planning and level placement"
priceFactors:
  - "Number of pieces or shelves"
  - "Weight and size of items"
  - "Wall type (drywall, brick, tile, masonry)"
  - "Gallery-wall layout complexity"
process:
  - "Send photos of the wall and the pieces or shelves you want hung"
  - "Receive a clear, itemized estimate"
  - "Schedule installation at a convenient time"
  - "Hang, level, anchor, and clean up completely"
faqs:
  - question: "Can you hang a full gallery wall, not just one picture?"
    answer: "Yes. We plan spacing and levels before drilling so a multi-piece gallery wall reads as one composition, not a scattered set of holes."
  - question: "Will floating shelves actually hold weight?"
    answer: "We anchor into studs wherever possible and use rated hardware sized to the shelf and expected load — we don't rely on drywall alone for weight-bearing brackets."
  - question: "Can you hang heavy or oversized mirrors?"
    answer: "Yes. Heavy mirrors need the right anchoring and often two-person handling — tell us the size and weight so we bring the right hardware."
  - question: "Do you hang pictures on brick or tile?"
    answer: "Yes, with the right masonry bits and anchors for those surfaces."
  - question: "How is this different from your general handyman service?"
...
- New-home buyers finishing a room after move-in
- Sellers staging a home for listing photos
- Anyone with a single gallery wall, mirror, or shelf project who doesn't need a full punch-list visit
- Homeowners who've hung something before and had it come loose or crooked

## What we hang and mount
...
Send photos of the wall and the pieces or shelves you want hung, with rough sizes if you have them. We'll return a clear, itemized estimate and get you on the schedule.
