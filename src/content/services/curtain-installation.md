...
primaryCTA: "Request Curtain Installation Quote"
secondaryCTA: "Call Us"
includedServices:
  - "Curtain rod and drapery hardware installation"
  - "Bracket placement and secure anchoring"
  - "Measurements for even hang and proper clearance"
  - "Mounting on drywall, wood trim, and common window surrounds"
  - "Coordination with existing blinds or shades when needed"
priceFactors:
...
process:
  ...
  - "Confirm rod placement, hardware, and anchoring approach"
  - "Install brackets and hardware with level, secure mounting"
  - "Hang treatments and verify smooth operation"
faqs:
  - question: "Do you install curtain rods on drywall only?"
    answer: "We mount on drywall, wood trim, and common window surrounds. We use appropriate anchors and find studs when needed for heavier treatments."
  - question: "Can you install rods before my curtains arrive?"
...
Curtain rods, brackets, and related hardware for bedrooms, living rooms, and dining spaces. We anchor into structure whenever possible and use appropriate hardware for hollow walls when studs do not align with the design. Heavy drapery needs serious anchoring — we do not trust flimsy drywall-only solutions for expensive fabric. Measurements for even hang, proper clearance above baseboards, and coordination with existing blinds or shades are part of a careful install.

Many homeowners have us install rods and brackets first, then hang curtains when fabric arrives. Others want a full hang-and-dress visit once everything is on site. Either way, floors and trim are protected, hardware is level, and the room is left ready to enjoy. If you are unsure about rod style or bracket spacing, send photos and we will recommend a practical approach based on window width and wall type.
